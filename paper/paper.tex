...
\hypersetup{                                                    %设置网页链接颜色等
    ...
    urlcolor=red,                                              %链接到网站的链接将会变为蓝绿色（cyan）
}
...
\begin{abstract}
    ...
    \cite{lipman2024flowmatchingguidecode}\cite{lord2014introduction}\cite{Särkkä_Solin_2019}\cite{holderrieth2023fokker}
...
% \input{section/intro}
% \input{section/fpk}
% \input{section/numeric}
% \input{section/diffusion}
% \input{section/sec3}
\input{section/randomfield}
\input{section/spde1}
\input{section/spde2}
